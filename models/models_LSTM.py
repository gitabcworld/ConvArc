...
class ARCSkip(nn.Module):
    """
    This class implements the Attentive Recurrent Comparators with skip iterations. See ARC for information 
    about the module.
    *confidence: Additions to the ARC module is the constant which calculates the confidence in the probability 
    result is the best result is going to get by the number of iterations until this moment.

    To calculate the number of iterations that should be done there will be a budget which will be reduced 
    constantly by the number of iterations and the confidence in this 
    """
