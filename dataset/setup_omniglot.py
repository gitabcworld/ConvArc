# CODE from: https://github.com/pranv/ARC/tree/master/data
import os
...
os.system('wget https://github.com/brendenlake/omniglot/archive/master.zip -P ../data/')
os.system('unzip -a ../data/master.zip -d ../data/')

path_bg = os.path.join('../data','omniglot-master', 'python', 'images_background.zip')
path_ev = os.path.join('../data','omniglot-master', 'python', 'images_evaluation.zip')
path_os = os.path.join('../data','omniglot-master', 'python', 'one-shot-classification', 'all_runs.zip')
...
np.save('../data/omniglot', all_imgs)
...
os.mkdir('../data/one_shot')
np.save('../data/one_shot/X', X_OS)
np.save('../data/one_shot/y', y_OS)

# clean up. just leave what is required.
os.system('rm ../data/master.zip')
os.system('rm -rf ../data/omniglot-master/')
